...
[![Travis build status](https://travis-ci.org/daqana/dqshiny.svg?branch=master)](https://travis-ci.org/daqana/dqshiny)
...
The goal of dqshiny is to provide highly customizable modules to enhance your
...
textInputs you may have a look at this:
...
this example could be quite interesting:
