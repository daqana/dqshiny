...
test_that("all filters work for empty data", {
  ...
  expect_silent(filter_row(NULL, df))
  expect_silent(filter_row(NULL, df, reset = FALSE))
  expect_silent(filter_row(NULL, df, "S"))
  expect_silent(filter_row(NULL, df, "R"))
  expect_silent(filter_row(NULL, df, ""))
})
...
test_that("all filters work for proper data", {
  ...
  expect_silent(filter_row(NULL, df))
  expect_silent(filter_row(NULL, df, reset = FALSE))
  expect_silent(filter_row(NULL, df, sorting = TRUE))
  expect_silent(filter_row(NULL, df, "s"))
  expect_silent(filter_row(NULL, df, "R"))
  expect_silent(filter_row(NULL, df, ""))
  expect_silent(filter_row(NULL, df, c("T", "S")))
  expect_silent(filter_row(NULL, df, c("t", "s", "r")))
  expect_silent(filter_row(NULL, df, c("T", "S", "r", "T")))
  expect_silent(filter_row(NULL, df, c("T", "s", "R", "", "R")))
  expect_silent(filter_row(NULL, df, c("T", NA, "NA", NULL)))
  expect_silent(filter_row(NULL, df, c(NA, "something", "strange", "")))
})
